...
BOOST_AUTO_TEST_CASE(jumpdest_removal_subassemblies)
{
	...
	Assembly main{false, settings.evmVersion, solidity::test::CommonOptions::get().eofVersion(), {}};
	AssemblyPointer sub = make_shared<Assembly>(true, settings.evmVersion, solidity::test::CommonOptions::get().eofVersion(), string{});
